class com.clubpenguin.util.Loader
{
   ...
   static function loadAllMovies($parent, $movieLocations, $initLocaleText)
   {
      ...
      else
      {
         ...
         _loc6_ = com.clubpenguin.util.Loader.localeOverride == undefined ? com.clubpenguin.util.LocaleText.LANG_ID_EN : com.clubpenguin.util.Loader.localeOverride;
         _loc7_ = com.clubpenguin.util.Loader.localeVersion == undefined ? com.clubpenguin.util.Loader.localeVersion : com.clubpenguin.util.Loader.localeVersion;
         if($initLocaleText)
         {
